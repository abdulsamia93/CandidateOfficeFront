...
import ListView from "@/views/ApproveEntity/SubConstituency/Components/ListView.vue";
...
export default {
  ...
  data: function() {
    return {
      messages:null,
      links: [{ name: "مكتب طرابلس", url: "/" }, { name: "تأكيد كيان", url: "/ApproveEntity" }, { name: "الدوائر", url: "/ApproveEntity/Subconstituency" }]
    };
  },
  created() {
    this.$parent.pages= [
