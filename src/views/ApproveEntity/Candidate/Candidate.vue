...
import ListView from "@/components/Entity/Candidate/ListView.vue";
...
export default {
  ...
  data: function() {
    return {
      messages:null,
      links: [{ name: "مكتب طرابلس", url: "/" }, { name: "تأكيد كيان", url: "/ApproveEntity" }, { name: "المرشحين", url: "/ApproveEntity/Candidate" }]
    };
  },
  created() {
    this.$parent.pages= [
