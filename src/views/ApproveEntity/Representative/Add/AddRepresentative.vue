...
import ListView from "@/components/Entity/Representative/Add/ListView.vue";
...
export default {
  ...
  data: function() {
    return {
      messages:null,
      links: [{ name: "مكتب طرابلس", url: "/" }, { name: "تأكيد الكيان", url: "/ApproveEntity" }, { name: "الممثلين", url: "/ApproveEntity/Representative" }]
    };
  },
  created() {
    this.$parent.pages= [
