<template>
  <div class="List-View">
    <div class="List-Header">
      <div class="Info-Box">
        <div class="List-Title">أضف مزكي</div>
        <div class="List-Des">أضف مزكين للكيان السياسي</div>
      </div>
  ...
  <div class="Input-Box">
      <div class="Label">الرقم الوطني للمزكي</div>
      <input class="Input" v-model="VName">
  </div>

      <div class="Btn-Add">إضافة</div>
      <div class="Btn-Add">إغلاق</div>
    </div>
  </div>
</template>
